...
const getExams = () => {
  ...
  fetch(
    `https://frida.up.railway.app/api/exams?subject=${selectedSubject}&nQuestions=${selectedNQuestions}`,
    {
      method: "GET",
      headers: {
...
const getExam = async (id) => {
  Swal.fire({
    ...
    didOpen: async () => {
      Swal.showLoading();
      const res = await fetch(`https://frida.up.railway.app/api/exams/${id}`, {
        method: "GET",
        headers: {
          authorization: `Bearer ${jwtToken}`,
        },
