...
function validatePassword(passwordInput) {
    const passwordRegex = /[0-9a-zA-Z~`!@#$%^&*()\-+={}[\]|\:;"'<>\\,.?\/ _]{6,50}/;
...
button.addEventListener("click", e => {
    if (validateName(firstName.value) && 
        ...
        const tmpData = JSON.stringify([firstName.value, lastName.value, email.value, password.value]);
